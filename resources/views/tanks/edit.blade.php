        ...
        <div class="row">
            <div class="col-xs-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="certificate_id" value="{{ $certificate->certificate_id }}"
                        class="form-control" placeholder="Certificate id">
                </div>
            </div>
            <div class="col-xs-12 mb-3">
                <div class="form-group">
            ...
            <div class="col-xs-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="certificate_name" value="{{ $certificate->container_id }}"
